...
console.log(gJ);
// gJ.addTo(map);
// material.io/icons/   GET SOME ICONS HERE
// graphic design inspiration: dribbble

var removeMarkers = function(goAway){
  _.each(goAway, function(datum){
    map.removeLayer(datum);
  });
  // _.each(goAway, function(map.removeLayer(goAway))

};

/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
var snapAccess = L.geoJson(farmerSet, {
...
////////////////////////////////////////////////////////////////////
var sat = L.geoJson(farmerSet, {
        filter: function(feature, layer) {
            return feature.properties.DAY == "Sat";
        }
    });
////////////////////////////////////////////////////////////////////
    var centerMarkets = L.geoJson(farmerSet, {
            filter: function(feature, layer) {
                return feature.properties.NEIGHBORHOOD == "Center City";
            }
        });
////////////////////////////////////////////////////////////////////

var south = L.geoJson(farmerSet, {
        filter: function(feature, layer) {
            return feature.properties.NEIGHBORHOOD == "South";
        }
    });
////////////////////////////////////////////////////////////////////
console.log(snapAccess);
console.log(timeOpen);
console.log(southMarkets);
